...
alias editnu = nvim ~/.config/nushell/config.nu; 


def --env n [...file: string] {
	# check if file is empty, and if it is, run nvim .
...
def --env gitaliases [] {
	scope aliases | where expansion starts-with "git" | select name expansion
} 
# Housekeeping aliases

def --env la [] { (ls -a) | sort-by type; }
# def --env lah [] { ls -ah | sort-by type; }
...
def --env enabledockresize [] {
	defaults write com.apple.Dock size-immutable -bool false; 
	killall Dock;
} 
def --env disabledockresize [] {
	defaults write com.apple.Dock size-immutable -bool true; 
	killall Dock;
}

source ~/.cache/carapace/init.nu
source ~/.cache/nuscripts/init.nu
source ~/.cache/.zoxide.nu
use ~/.cache/starship/init.nu

def --env --wrapped cdls [...goto: string] {
	__zoxide_z ...$goto
	print (ls . | sort-by type)
}
alias cd = cdls;
